...
public class RedisDao {
    ...
    private final String REDIS_NOT_EX = "null";
    ...
    public boolean isExist(Object value) {
        return !REDIS_NOT_EX.equals(value);
    }
     ...
     * @return
     */
    public List hmultiGet(String H, Collection<Object> collection){
    ...
    public boolean saddHasTime(String K, String V, Long millisecond){
        redisTemplate.opsForSet().add(K,V);
        expire(V,millisecond);
        return true;
    }
